...
namespace e_commerce_server.src.Core.Database.Migrations
{
    ...
    [Migration("20230410033846_add_user_district_foreign_key")]
    partial class add_user_district_foreign_key
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("e_commerce_server.src.Core.Database.Data.ProductData", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = 1,
                            category_id = 1,
                            created_at = new DateTime(2023, 4, 10, 10, 38, 46, 476, DateTimeKind.Local).AddTicks(4873),
                            ...
                            price = 120000,
                            status_id = 1,
                            updated_at = new DateTime(2023, 4, 10, 10, 38, 46, 476, DateTimeKind.Local).AddTicks(4882),
                            user_id = 1
                        });
                });
